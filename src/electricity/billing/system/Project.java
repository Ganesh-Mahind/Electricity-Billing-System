...
public class Project extends JFrame  implements ActionListener{
    ...
    Project(String atype, String meter){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icon/wi.jpeg"));
...
//         master.setPreferredSize(new Dimension(100,master.getPreferredSize().height));
           master.setFont(new Font("momospaced",Font.PLAIN,20));
         
          
         JMenuItem newcustomer = new JMenuItem("New Customer");
         newcustomer.setFont(new Font("momospaced",Font.PLAIN,30));
        ...
        customerdetails.setFont(new Font("monospaced", Font.PLAIN, 30));
        ...
        depositdetails.setFont(new Font("monospaced", Font.PLAIN, 30));
        ...
        calculatebill.setFont(new Font("monospaced", Font.PLAIN, 30));
        ...
        updateinformation.setFont(new Font("monospaced", Font.PLAIN, 30));
        ...
        viewinformation.setFont(new Font("monospaced", Font.PLAIN, 30));
        ...
        info.add(viewinformation);
         ...
         user.setForeground(Color.BLUE);
           ...
           user.setFont(new Font("momospaced",Font.PLAIN,20));
         
         
        
        
        JMenuItem paybill = new JMenuItem("Pay Bill");
        paybill.setFont(new Font("monospaced", Font.PLAIN, 30));
        ...
        billdetails.setFont(new Font("monospaced", Font.PLAIN, 30));
        ...
        generatebill.setFont(new Font("monospaced", Font.PLAIN, 30));
        ...
        report.add(generatebill);
         ...
         utility.setForeground(Color.BLUE);
           ...
           utility.setFont(new Font("momospaced",Font.PLAIN,20));
         
         
          
        JMenuItem notepad = new JMenuItem("Notepad");
        notepad.setFont(new Font("monospaced", Font.PLAIN, 30));
        ...
        calculator.setFont(new Font("monospaced", Font.PLAIN, 30));
        ...
        utility.add(calculator);
         ...
         mexit.setForeground(Color.BLUE);
           ...
           mexit.setFont(new Font("momospaced",Font.PLAIN,20));
